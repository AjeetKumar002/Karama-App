  ...
  return (
    <SafeAreaView style={styles.SafeAreaView}>
        <View style={styles.back}>
            ...
            <Image source={require("../../../assets/images/TopBarArow.png")} alt='back' style={{width:28, height: 28}} />
              </TouchableOpacity>
          ...
          <View style={styles.container}>
            <View style={styles.weHave}>
              <View style={{gap: 16}}>
                ...
                <View style={styles.weHaveImages}>
                  <SimpleBadgeComponent BadgeIcon={Religion3} BadgeText="Buddhism" />
                </View>
              </View>
              <View style={{gap: 16}}>
                <Text style={styles.weHaveText}>Personality</Text>
                <View style={styles.weHaveImages}>
                  <SimpleBadgeComponent BadgeIcon={Personality3} BadgeText="Chill" />
                  <SimpleBadgeComponent BadgeIcon={Personality4} BadgeText="Patient" />
                  <SimpleBadgeComponent BadgeIcon={Personality5} BadgeText="Wacky" />
                </View>
              </View>
              <View style={{gap: 16}}>
            ...
            <View style={styles.workFor}>
              ...
              <View style={{gap: 16}}>
                ...
                <View style={styles.weHaveImages}>
                  ...
                  />
                  <SimpleBadgeComponent BadgeIcon={Requirements4} BadgeText="Can Swim" />
                  <SimpleBadgeComponent
          ...
          <View style={styles.responsibilities}>
            <View style={styles.responsibilitiesFor}>
              <View style={{gap: 16}}>
                ...
                <View style={styles.weHaveImages}>
                  <SimpleBadgeComponent BadgeIcon={Childcare2} BadgeText="Bathing" />
                  <SimpleBadgeComponent BadgeIcon={Childcare11} BadgeText="Tutoring" />
                  <SimpleBadgeComponent
              ...
              <View style={{gap: 16}}>
                ...
                <View style={styles.weHaveImages}>
                  <SimpleBadgeComponent BadgeIcon={Creative2} BadgeText="Cooking" />
                  <SimpleBadgeComponent BadgeIcon={Respon7} BadgeText="Pet Care" />
                  <SimpleBadgeComponent
                    BadgeIcon={Childcare3}
                    BadgeText="Meal Prep"
                  />
                  <SimpleBadgeComponent BadgeIcon={Respon4} BadgeText="Laundry" />
                  <SimpleBadgeComponent
                    BadgeIcon={Respon11}
